...
__DEFINE__(1642399315263, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642399315264,"./event-store":1642399315265}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642399315264, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642399315265, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642399315264,"./utils":1642399315266}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642399315266, function(require, module, exports) {
...
return __REQUIRE__(1642399315263);
})()
