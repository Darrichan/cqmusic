...
__DEFINE__(1642127527624, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642127527625,"./event-store":1642127527626}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642127527625, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642127527626, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642127527625,"./utils":1642127527627}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642127527627, function(require, module, exports) {
...
return __REQUIRE__(1642127527624);
})()
